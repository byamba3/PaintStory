...
public class PaintFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            mPaintView.paths = (ArrayList<FingerPath>) MainActivity.savedPaths.clone();
            mPaintView.undonePaths = (ArrayList<FingerPath>) MainActivity.savedUndonePaths.clone();
        }
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        MainActivity.savedPaths = (ArrayList<FingerPath>) mPaintView.paths.clone();
        MainActivity.savedUndonePaths = (ArrayList<FingerPath>) mPaintView.undonePaths.clone();
            ...
            public void onClick(View v) {
                ...
                filepath.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        @SuppressWarnings("VisibleForTests") String downloadURL =
                                taskSnapshot.getDownloadUrl().toString();
                        StoryItem newStoryUpload =
                                new StoryItem(postTitle, downloadURL, currentTime.getTimeInMillis());
                    ...
                    public void onFailure(@NonNull Exception e) {
                        mProgress.dismiss();
                        String errorMessage = "Uploading could not complete!";
    ...
    public void displayBrushPicker(){
        ...
        if (mSelectedBrushType != -1) {
            RadioButton savedCheckedRadioButton = (RadioButton) mRadioGroupBrushType
                    .getChildAt(mSelectedBrushType);
